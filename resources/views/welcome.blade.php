...
">
    ...
    ">
        ...
        @if (file_exists(public_path('images/logo-tefa.png')))
            <img src="{{ asset('images/logo-tefa.png') }}" alt="Logo TEFA SMKN 1 Bangsri" class="h-16 w-auto object-contain mx-auto mb-2">
        @else
            <div class="logo-box">
                <svg
        ...
        {{-- Tombol --}}
        @auth
            <a href="{{ route('dashboard') }}" class="btn-masuk flex items-center justify-center gap-2.5 leading-none py-3 px-4">
                <svg
        ...
        @else
            <a href="{{ route('login') }}" class="btn-masuk flex items-center justify-center gap-2.5 leading-none py-3 px-4">
                <svg
                    class="w-5 h-5 shrink-0"
                    fill="none"
                    viewBox="0 0 24 24"
