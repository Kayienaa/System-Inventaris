...
<div class="sip-container">
    ...
    <div class="sip-header">
        ...
        <div style="display: flex; gap: 0.5rem; flex-wrap: wrap;">
            <form action="{{ route('admin.sync-sipintu') }}" method="POST" onsubmit="return confirm('Mulai sinkronisasi data GURU ke database lokal SITEFA? Proses ini memerlukan beberapa saat.')">
                @csrf
