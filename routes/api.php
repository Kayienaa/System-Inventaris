...
Route::middleware('auth')->group(function (): void {
    ...
    Route::middleware(['role:admin|super_admin', 'permission:assets.create'])->post('admin/assets', [AssetController::class, 'store']);
    Route::middleware(['role:admin|super_admin', 'permission:assets.update'])->match(['put', 'patch'], 'admin/assets/{asset}', [AssetController::class, 'update']);
    Route::middleware(['role:admin|super_admin', 'permission:assets.delete'])->delete('admin/assets/{asset}', [AssetController::class, 'destroy']);
    Route::apiResource('admin/asset-categories', AssetCategoryController::class)->middleware(['role:admin|super_admin', 'permission:assets.create']);
    ...
    Route::post('borrowings/{borrowing}/checkout', [BorrowingController::class, 'checkout'])->middleware('can:checkout,borrowing');
    ...
    Route::get('admin/audit-logs', [AuditLogController::class, 'index'])->middleware(['role:super_admin', 'permission:audit.view']);
});
